...
+ El objetivo central de este escrito: Informar a nuestro cliente con la mayor cantidad de herramientas, datos, informacion, metodologias, etc. que le permitan tomar una accion financiera lo mas acertada posibles para generar una **inversión eficaz** 
...
**`INVERSION COMO PROCESO MULTIFACTORIAL`**:
+ Como punto de partida se propone ver la inversion como un hecho caracterizado por la covarianza. Un elemento de un sistema, en el que al modificarse cualquiera de los elementos inter-relacionados a el, se vera sustancialmente modificado. es por ello que haremos un analsis, aunque superfisial, lo mas amplio posible, sin dejar de considerar nuestro rol central como analista de datos. 

<p align="center">
<img src="https://github.com/mrdesautu/DataAnalytics-PIN-2/blob/main/recursos/interdisciplina.jpg"  height=300>
</p>
...
| **Plazos de la inversión** | Los plazos de una inversión se refieren al periodo durante el cual el inversor decide mantener su inversión antes de venderla. Los plazos pueden variar desde corto plazo (menos de un año), hasta mediano y largo plazo (uno a cinco años o más). Encontrarás un cuadro que especifica cada uno de los plazos.  |
| **Riesgo de nuestra inversion** | El riesgo de una inversión se refiere a la probabilidad de que se produzca una pérdida financiera como resultado de factores impredecibles o inciertos que afectan el valor de la inversión. Es importante que los inversores evalúen su tolerancia al riesgo antes de realizar una inversión. |
| **Legislación y Regulación vigente** | refieren a las leyes, normativas y políticas gubernamentales que establecen las reglas y los requisitos para la realización de inversiones por parte de individuos, empresas y otras entidades. |
...
Un ROI alto indica que la inversión ha sido rentable y ha generado ganancias significativas en relación al costo de la inversión. Por otro lado, un ROI bajo indica que la inversión no ha sido rentable y que se han obtenido pocas ganancias en relación al costo total de la inversión. El ROI es una herramienta importante para los inversionistas, ya que les permite comparar la rentabilidad de diferentes inversiones y tomar decisiones informadas sobre dónde invertir su dinero.

+ Índice de Volatilidad: El índice de volatilidad, también conocido como VIX, es un indicador que mide la volatilidad implícita en el mercado de opciones sobre el índice S&P 500. En otras palabras, el VIX refleja las expectativas del mercado sobre la volatilidad futura del S&P 500, que es uno de los principales índices bursátiles de Estados Unidos. El VIX es a menudo llamado el "indicador del miedo" ya que su valor tiende a aumentar cuando los inversores esperan que los mercados sean más volátiles y a disminuir cuando los inversores esperan que los mercados sean más estables.
...
+ Volumen de negociación: El volumen de negociación del S&P 500 es importante porque puede proporcionar información sobre el interés y la actividad de los inversores en el mercado de valores. Un alto volumen de negociación generalmente indica una mayor actividad y liquidez en el mercado, lo que puede ser una señal de confianza y optimismo en la economía y en las empresas que componen el índice.
Por otro lado, un bajo volumen de negociación puede indicar una menor actividad en el mercado, lo que puede reflejar incertidumbre o falta de interés por parte de los inversores.
Es importante tener en cuenta que el volumen de negociación del S&P 500 no es el único factor que influye en el desempeño del mercado, ya que existen otros factores económicos, políticos y sociales que también pueden tener un impacto significativo en el mercado de valores.

<br/> 

**`Plazos de inversiones`**:

| Plazo	| Descripción	| Ejemplo |
|-------|----------------|---------|
| **Corto plazo** | Periodo de tiempo menor a 1 año. Se enfoca en la liquidez y la estabilidad financiera a corto plazo. |	Inversión en bonos corporativos a corto plazo de una empresa para financiar su capital de trabajo y cubrir gastos a corto plazo. |
| **Mediano plazo** |	Periodo de tiempo entre 1 a 5 años. Se enfoca en la expansión y crecimiento de la empresa en un horizonte temporal intermedio.	| Inversión en acciones de una empresa que está en proceso de expandirse a nuevos mercados y lanzar nuevos productos en los próximos años. |
| **Largo plazo**	| Periodo de tiempo mayor a 5 años. Se enfoca en el crecimiento y desarrollo sostenible de la empresa a largo plazo. |	 Inversión en acciones de una empresa que está invirtiendo en investigación y desarrollo para lanzar productos disruptivos en la próxima década y consolidarse como líder en su sector. |
...
Para invertir directamente en el S&P 500 a través de un ETF, los pasos que se pueden seguir son los siguientes:
Abrir una cuenta de corretaje en línea con una firma de corretaje o una empresa de inversión que ofrezca la negociación de ETFs.
Depositar dinero en la cuenta de corretaje.
Buscar el ETF que sigue el S&P 500 y comprarlo a través de la plataforma de negociación en línea de la firma de corretaje.
Algunos de los ETFs que siguen el S&P 500 son el SPDR S&P 500 ETF Trust (SPY), el iShares Core S&P 500 ETF (IVV) y el Vanguard S&P 500 ETF (VOO). Es importante investigar cada uno de estos fondos y sus costos asociados antes de tomar una decisión de inversión.
...
+ La preponderancia de sus valores es una pendiente positiva. Consideremos que cuanto mayor tiempo nos encontremos en pendiente positiva y menor en pendiente negativa maximizaremos nuestras ganancias.      
+ Contamos con indicdores para hacer hipótesis predictivas, tenerlas en cuenta aumenta significativamente nuestra probabilidad de acertar con nuestras estimaciones. 
+ La decision de el capital a invertir y el riesgo a asumir siempre debe estas guiada por nuestros objetivos empresariales. 


<p align="center">
<img src="https://github.com/mrdesautu/DataAnalytics-PIN-2/blob/main/recursos/objetivos.jpg"  height=300>
</p>
...
+ Plazp fijo en Dolares (https://www.cronista.com/finanzas-mercados/plazo-fijo-en-dolares-la-alternativa-de-inversion-que-encamina-a-ser-la-mejor-en-2023/#:~:text=Algunos%20bancos%20brindan%20ganancias%20efectivas,y%200%2C5%25%20anual.)
+ Analisis actualizado del mercado: (https://www.portfoliovisualizer.com/backtest-portfolio#analysisResults)
+ Factores a considerar por inversionistas:(https://www.estrategiasdeinversion.com/analisis/bolsa-y-mercados)
+ Estado general del Mercado:(https://www.currentmarketvaluation.com/models/buffett-indicator.php)
